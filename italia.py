...
from PyQt5.QtWidgets import QTableWidgetItem, QMessageBox, QProgressBar, QStatusBar, QHeaderView, QCompleter
from sql import get_spare_parts, save_prices, get_model, save_to_basket, get_basket, save_basket, get_prices_date,\
    save_order, get_orders_dates, get_history, make_changed_order
import ml_sql
